 ...
 * <p/>
 * The resource server is located at "/selfie", and can be accessed only by retrieving a token from "/oauth/token"
...
public class OAuth2SecurityConfiguration {
     ...
     * resource server (i.e. the "/selfie" endpoint)
     */
    @Configuration
    ...
    protected static class ResourceServer extends
        ...
        // all of the paths in the selfie service.
        @Override
    ...
    protected static class OAuth2Config extends
         ...
         * passwords listed below and updating the SelfieSvcClientApiTest.
         *
         * @param
         * @throws Exception
         */
        public OAuth2Config() throws Exception {
            ...
            ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
                    ...
                    .scopes("read", "write").resourceIds("selfie")
                    .and()
                            // Create a second client that only has "read" access to the
                            // selfie service
                    .withClient("mobileReader").authorizedGrantTypes("password")
                    .authorities("ROLE_CLIENT")
                    .scopes("read").resourceIds("selfie")
                    .accessTokenValiditySeconds(3600).and().build();

            // Create a series of hard-coded users.
            UserDetailsService svc = new InMemoryUserDetailsManager(
                    Arrays.asList(
                            User.create("admin@example.com", "pass", "ADMIN", "USER"),
                            User.create("user0@example.com", "pass", "USER"),
                            User.create("foo@example.com", "pass", "USER")));
